...
import type { Module, Declaration, CombDecl, AlwaysBlock, AssertDecl, ConstraintDecl, Expr, Statement, VNode, VSlot } from './ast.js';
...
export function verify(mod: Module, moduleRegistry?: Map<string, Module>): VerifyResult {
  ...
  const builtins = new Set(['str', 'int', 'float', 'len', 'contains', 'append', 'push', 'pop', 'slice', 'map', 'filter', 'concat', 'Math', 'JSON', 'console', 'Object', 'parseInt', 'parseFloat', 'toString', 'rgbToHsv', 'hsvToRgb', 'rgbToHex']);
